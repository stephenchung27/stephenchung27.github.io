...
document.addEventListener("DOMContentLoaded", () => {
  ...
  Object(_waves__WEBPACK_IMPORTED_MODULE_3__["default"])("waves", ['#521D1F', '#FF6A66', '#ffffff'], 0.4);
  Object(_waves__WEBPACK_IMPORTED_MODULE_3__["default"])("projects-arrow", ['#521D1F', '#FF6A66', '#1B1B1F']);
  Object(_waves__WEBPACK_IMPORTED_MODULE_3__["default"])("contact-arrow", ['#521D1F', '#ffffff', '#FF5851']);
  // setupArrow();
  // setupContact();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.to-the-top').click((e) => {
    const jump = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.to-the-top').attr('href');
    const new_position = jquery__WEBPACK_IMPORTED_MODULE_0___default()(jump).offset();
...
const runSplash = () => {
    ...
    while (i--) {
      ...
      if (n) {
        ...
        while (l--) {
          ...
          conn(p, pnxt);
          const _px = (p.x - pnxt.x) / _dist(pnxt, p);
          const _py = (p.y - pnxt.y) / _dist(pnxt, p);
          p.velX -= _px * pull;
          p.velY -= _py * pull;
        }
      }
  ...
  function Node(c, px, py) {
    ...
    _p.res_ = function (px, py) {
      ...
      _p.gx = rnd(-5, 5);
      _p.gy = rnd(-5, 5);
      _p.x = px || rnd(10, canvas.width - 10);
      _p.y = py || rnd(10, canvas.height - 10);
      _p.gx2 = rnd(-2, 2) * .5;
      _p.gy2 = rnd(-2, 2) * .5;
    ...
    _p.upos = function () {
      ...
      if (_p.x + _p.velX > canvas.width) _p.velX *= -1;
      else if (_p.x + _p.velX < 0) _p.velX *= -1;
      if (_p.y + _p.velY > canvas.height) _p.velY *= -1;
...
/* harmony default export */ __webpack_exports__["default"] = (drawWaves);
